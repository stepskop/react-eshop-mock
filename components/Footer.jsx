...
export default function Footer() {
    return (
        <>
            <footer className="mt-14 my-4 p-3 border-2 border-white rounded-2xl w-80 mx-auto lg:hidden">
            ...
            <footer
                className="w-[60%] mx-auto mb-4 border-2 border-white rounded-2xl shadow-xl p-6 mt-[14em] flex flex-row justify-around">
