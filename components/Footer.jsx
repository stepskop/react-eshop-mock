...
export default function Footer() {
    return (
        <>
            <footer
                className="lg:w-[72rem] max-w-[97vw] md:w-[45rem] w-80 mx-auto mb-4 border-2 border-white rounded-2xl shadow-xl p-6 mt-[14em] flex flex-row justify-around bottom-0">
