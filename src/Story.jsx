  ...
  return (
    <>
      <section className="flex flex-col align-items-center w-80 mx-auto">
        <div className="border-2 border-white rounded-2xl shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] w-80 mx-auto mt-12 p-3 px-4">
          <h1 className="text-3xl  pb-4">This is we</h1>
          <p>
            <span className="text-[#78aeff] text-xl ">L</span>orem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem
